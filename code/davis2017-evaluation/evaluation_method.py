...
# Modified davis2017 for 2016 https://github.com/davisvideochallenge/davis2017-evaluation/issues/4

default_davis_path = '../data/DAVIS_2016'
...
parser.add_argument('--results_path', type=str, help='Path to the folder containing the sequences folders',
                    required=True)
parser.add_argument("--year", type=str, help="Davis dataset year (default: 2017)", default='2017', choices=['2016', '2017', '2019'])
